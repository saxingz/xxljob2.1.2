...
public class JobFailMonitorHelper {
	...
	public static JobFailMonitorHelper getInstance(String profile){
		JobFailMonitorHelper.profile = profile;
		return instance;
	}
	...
	private boolean failAlarm(XxlJobInfo info, XxlJobLog jobLog){
		...
		if (info!=null && info.getAlarmEmail()!=null && info.getAlarmEmail().trim().length()>0) {
			...
			String title = profile + " - " + I18nUtil.getString("jobconf_monitor");
